...
#              the nav2_params_path yaml file and the SDF file: amcl ---> initial_pose: [x, y, z, yaw]
#              We use speed limit zones here so the robot has limited speed in specific areas of the world.
...
def generate_launch_description():
  ...
  map_file_path = 'maps/warehouse_world/warehouse_world_speed_limit_zones.yaml'
  nav2_params_path = 'params/warehouse_world/speed_limit_zones_params.yaml'
  robot_localization_file_path = 'config/ekf.yaml'
  rviz_config_file_path = 'rviz/warehouse_world/nav2_config_speed_limit_zones.rviz'
  sdf_model_path = 'models/two_wheeled_robot_description/model.sdf'
  urdf_file_path = 'urdf/two_wheeled_robot.urdf'
  world_file_path = 'worlds/warehouse_speed_limit_zones.world'
  ...
  # UNCOMMENT HERE FOR SPEED LIMIT ZONES DEMO
