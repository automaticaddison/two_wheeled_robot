...
#              We use keepout zones here so the robot only travels along specific paths inside the world.
...
def generate_launch_description():
  ...
  map_file_path = 'maps/warehouse_world/warehouse_world_keepout_zones.yaml'
  nav2_params_path = 'params/warehouse_world/keepout_zones_params.yaml'
  robot_localization_file_path = 'config/ekf.yaml'
  rviz_config_file_path = 'rviz/warehouse_world/nav2_config_keepout_zones.rviz'
  sdf_model_path = 'models/two_wheeled_robot_description/model.sdf'
  urdf_file_path = 'urdf/two_wheeled_robot.urdf'
  world_file_path = 'worlds/warehouse_keepout_zones.world'
