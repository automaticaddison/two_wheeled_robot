...
def generate_launch_description():
  ...
  map_file_path = 'maps/factory_world/factory_world.yaml'
  nav2_params_path = 'params/factory_world/nav2_params.yaml'
  robot_localization_file_path = 'config/ekf.yaml'
  rviz_config_file_path = 'rviz/factory_world/nav2_config.rviz'
