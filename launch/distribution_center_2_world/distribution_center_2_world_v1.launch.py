...
def generate_launch_description():
  ...
  map_file_path = 'maps/distribution_center_2_world/distribution_center_2_world.yaml'
  nav2_params_path = 'params/distribution_center_2_world/nav2_params.yaml'
  robot_localization_file_path = 'config/ekf.yaml'
  rviz_config_file_path = 'rviz/distribution_center_2_world/nav2_config.rviz'
  sdf_model_path = 'models/two_wheeled_robot_description/model.sdf'
  urdf_file_path = 'urdf/two_wheeled_robot.urdf'
  world_file_path = 'worlds/distribution_center_2.world'
